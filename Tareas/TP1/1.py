...
======================================================
Consigna:
    Se busca realizar una librería en Python que nos permita 
    obtener $N$ muestras de las siguientes señales de período
    $T_0=1/f_0$, muestreadas a una frecuencia $f_s$:
